...
```sql
-- Scripts para crear tablas de Oracle HR sample schema.
-- Author: Oracle Corporation
-- Date: June, 2024
-- Note: This script is for educational purposes and may not be suitable for production use.
-- The script creates tables, indexes, sequences, constraints, and inserts sample data into the tables.
-- The script also includes comments on tables and columns for better understanding of the schema.
-- The script is designed to be run in an Oracle database environment and may require adjustments for other database systems.
-- Before running the script, ensure that you have the necessary permissions to create tables, indexes, sequences, and constraints in the database.
...
-- Create a trigger to prevent DML on the employees table outside of office hours
